...
public class Solution {
    public static final String TEXT_KEY_CAT = "cat.string";
    public static final String TEXT_KEY_DOG = "dog.string";
    ...
    public static Thread SERVER_THREAD = new Thread(new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                registry.bind(TEXT_KEY_CAT, stubCat);
                stubDog = UnicastRemoteObject.exportObject(dog, 0);
                registry.bind(TEXT_KEY_DOG, stubDog);
            } catch (RemoteException e) {
                e.printStackTrace();
